...
public class TimeToWords_Q1 {
	...
	/**
	 * The function "input" prompts the user to enter a number between 1 and 12 for hours and
	 * a number between 0 and 59 for minutes.
	 */
	void input() {
	...
	/**
	 * The function "cal" determines the time based on the given hour and minute values and
	 * prints the corresponding time statement.
	 */
	void cal() {
		if (m == 0) {

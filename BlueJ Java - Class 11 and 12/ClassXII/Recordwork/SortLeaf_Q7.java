...
/**
 * Write a program where you create a single subscripted array of n > 0 integers. Get the
 * elements of the array from the user. Rearrange the same array in place in such a manner
 * that the greatest number should be placed in the middle, to its right second greatest,
 * on the left side if the greatest third greatest and so on.
 *
...
public class SortLeaf_Q7 {
	...
	/**
	 * `SortLeaf_Q7(int size)` is a constructor method that creates an instance of the
	 * `SortLeaf_Q7` class with an array of integers of size `size`.
	 */
	 ...
	 */
	void sort() {
		// Sorts the array completely before dividing it.
